...
{ 
    ...
    // Creating ntuple
    //
    analysisManager->CreateNtuple("HDS", "cosmic ray telescope");
...
void HDSRunAction::BeginOfRunAction(const G4Run* /*run*/)
{ 
  ...
  // Open an output file
  //
  G4String fileName = "HDS";
  analysisManager->OpenFile(fileName);
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void HDSRunAction::EndOfRunAction(const G4Run* /*run*/)
{
